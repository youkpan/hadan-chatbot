...
class Chatbot:
    ...
    def parseArgs(args):
        ...
        datasetArgs.add_argument('--maxLength', type=int, default=16, help='maximum length of the sentence (for input and output), define number of maximum step of the RNN')
    ...
    def mainTestInteractive(self, sess):
        ...
        while True:
            ...
            question = " ".join(questionc) #str(" ".join(questionc)).encoder("GBK")
            print(question)
